...
In Personalised Prevention Services we explicitly told teams to not think too much about working with the NHS app. We wanted to test the core hypothesis before engaging with a team that has an incredibly long backlog and an understandably high threshold of quality.

The NHS app is central to the 10‑year plan for the NHS. Many teams across DPSP are already building things for the app. Behaviour change, screening, vaccinations, child health, home testing – each working independently. I was in a few sessions where people were asking how we move from separate teams each doing their own thing to something that resembles the vision and who owns that problem. It felt necessary for DPSP to be able to answer those questions.
...
The scope will be in part set by how the app team want to federate responsibility. I think the app team are seeking to support more teams being able to work autonomously, shrinking the responsibility for the team to core needs shared by all teams across the app. From a distance, it looks like a question of topology or information architecture.

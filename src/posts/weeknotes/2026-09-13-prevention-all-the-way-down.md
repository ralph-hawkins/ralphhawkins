...
date: 2026-09-13
---
Service design is usually left‑to‑right. Service maps are almost always drawn this way. But there's a top‑to‑bottom axis too, from far‑reaching and vague to incremental and detailed. This week I worked at the detail – how the Managing My Health (MMH) team might change a single sentence in the app, from 'Hum papill vir DNA dtctn assay' to something like 'HPV test'. And at the vague end – what the NHS would look like if the technology were designed around users and staff.
...
Frankie wrote about the [work MMH are doing to make concrete fixes](https://frankieroberto.github.io/nhsnotes/posts/week-109-near-and-far/) – changing a label to be more readable – doing this as a patch vs fixing the root cause. I'm pro doing the patch. It'll teach us about shipping a change to the app. Part of our job is to support other teams working with the NHS App, and that's harder to do if we've never done that ourselves.

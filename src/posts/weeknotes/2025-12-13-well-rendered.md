...
{{ image("/images/weeknotes/2025-12-13-well-rendered/007.png", "Early vector version: basic shield shape with NHS logo, lungs, heart, and Digital prevention services banner") }}

{{ image("/images/weeknotes/2025-12-13-well-rendered/008.png", "Vector iteration: pink outlined shield with icons for search, health check, syringe, hands holding heart, and empty banner") }}

{{ image("/images/weeknotes/2025-12-13-well-rendered/009.png", "Vector iteration: simple blue glossy shield with heart icon") }}

{{ image("/images/weeknotes/2025-12-13-well-rendered/010.png", "Vector iteration: blue glossy shield with squiggle motif, heart, and hands") }}

{{ image("/images/weeknotes/2025-12-13-well-rendered/011.png", "Vector iteration: outlined shield with NHS logo, coloured icons for search, health check, syringe, hands holding heart") }}
...
{{ image("/images/weeknotes/2025-12-13-well-rendered/019.png", "Vector iteration: yellow shield with pink intestines as mantling, NHS logo, syringes, squiggle, hands holding heart, bowels, blue background") }}

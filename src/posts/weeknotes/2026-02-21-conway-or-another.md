...
It’s tricky to not want to go after something and dig into the whole of it. I often want to look at how we might work with one of the journeys. The work we're doing is about improving how things are presented. Reducing the burden on users by making the system less overwhelming.

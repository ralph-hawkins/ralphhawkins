...
This week we stopped to question whether we were moving in the right direction. It felt like we’d made a false start. I’ve felt torn between applying pressure to move forwards and the need to make sure we’re creating solid foundations.
...
Part of the need to reassess came from a set of stakeholders who wanted us to support something so far outside our assumed scope we hadn’t even considered it. It points to something more fundamental than the things we’d been looking at. What are the most important things we can do?
